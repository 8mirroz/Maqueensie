...
title: "Дашборд сравнения конкурентов"---
...
| **Input Contract** | Frontmatter per `[[GID_Правила_валидации]]` from `07_Competitors/` |
| **Output Contract** | Rendered tables + diagnostic report + export-ready markdown |
| **Dependencies** | `[[GID_Правила_валидации]]`, `[[tier_rules]]` |
...
- **Обязательный снимок**: перед обновлением `[[tier_rules]]`
...
3. **Расширенная валидация**: кросс-проверка с `[[tier_rules]]` на соответствие диапазонам
