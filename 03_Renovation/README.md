...
1. Открыть [[08_Pricing_Tables/04_Repair_Price_Matrix]] в Reading view
2. Проверить диагностику валидации
3. Экспортировать данные для сметы
4. Использовать [[03_Renovation/projects/project_template]] для расчета
...
|--------|-----------|---------|
| [[10_Guides/tier_rules]] | ← reads | Общие правила тиров для всех доменов |
| [[10_Guides/validation_rules]] | ← reads | Политики валидации данных |
| [[08_Pricing_Tables/04_Repair_Price_Matrix]] | → exports | Визуализация и экспорт данных |
...
- [[ARCHITECTURE]] — детальная системная архитектура
- [[10_Guides/REPOSITORY_DEVELOPMENT_PLAN]] — стратегия развития
- [[08_Pricing_Tables/02_Competitor_Comparison_Dashboard]] — аналогичная система для конкурентов
